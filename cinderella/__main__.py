...
PM_START_TEXT = """
_Hello_ *{}*
_എൻ്റെ പേര്_ *{}*\n_പെട്ടെന്ന് എന്നെ നിങ്ങടെ ഗ്രൂപ്പിലെക് അഡ് അക്കികൊ _ [{}](tg://user?id={})
"""
...
SOURCE_STRING = """
⚡I'm built in_ brain of my master [him] https://t.me/POWER_OF_TELEGRAM
[click](https://heroku.com/deploy?template=https://github.com/adithyan-pikachu12/PIKACHU_PRO_BOT")
"""
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="HELP",callback_data="help_back"),InlineKeyboardButton(text="☠️CREATOR☠️",url="https://t.me/POWER_OF_TELEGRAM")]]
